...
Customers log in as anonymous user to Milkcocoa by uuid generated by `uniqid()`. Customers' message data is stored to each Milkcocoa's DataStore named uuid.

You(Operator) loggged in by WordPress user name and access all customers' message data.

![](https://s3-us-west-2.amazonaws.com/mlkcca/milkcocoa-structure.png)
